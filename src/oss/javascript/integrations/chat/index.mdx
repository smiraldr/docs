...
import ChatDownloads from '/snippets/oss/javascript-chat-downloads.mdx';
import ChatFeatured from '/snippets/oss/javascript-chat-featured.mdx';
...
[IO Intelligence](https://io.net/) provides an OpenAI-compatible Chat Completions API for open-weight models. Use `ChatOpenAI` with `configuration.baseURL` `https://api.intelligence.io.solutions/api/v1`, an IO Intelligence API key, and a model ID such as `meta-llama/Llama-3.3-70B-Instruct`.
